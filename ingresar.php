  ...
  <div class="col-lg-5 col-md-10 col-sm-10 mx-auto">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p class="alert">Producto agregado existosamente</p>
          </div>
    ...
    <div class="card">
      <div class="card-header bg-warning text-center">
        <span class="font-weight-bold" id="operacion">Ingresar Productos</span>
      </div>
      <div class="card-body">
        ...
        <div class="form-group row ml-1 mt-2" >
          ...
          <div class="mr-5">
            <input type="radio" name="disponible" value="true" class="radios" checked> Si
          </div>
          <div class="mr-5">
            <input type="radio" name="disponible" value="false" class="radios"> No
          </div>
      ...
      <div class="card-footer">
        <button type="button" class="btn btn-info" id="agregar-btn">Agregar</button>
      </div>
